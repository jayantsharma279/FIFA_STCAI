...
Why PostgreSQL over NoSQL Databases in this case?
In this dataset, we are provided with a structured dataset in which a data can be filled in the columns. For such data (e.g., clubs, ages, structured data, and statistical queries), PostgreSQL is generally the better choice. It provides strong schema enforcement, complex querying capabilities, and ACID compliance, making it ideal for handling structured data and analytical queries reliably and efficiently.
NoSQL might be overkill, as it is graph database, it might not be the best tool for this dataset. Unless the data becomes highly unstructured or we need extreme scalability as a part of the functionality.
...
** Box Video Folder Link:**
https://cmu.box.com/s/b15t89zr404em5ofcqetid9wheh16uw3
